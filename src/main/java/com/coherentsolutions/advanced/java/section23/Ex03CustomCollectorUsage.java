...
/**
 * Ex03CustomCollectorUsage
 *
 * This class demonstrates the usage of a custom collector by collecting Person objects
 * into an immutable Map with conflict resolution (keeping maximum age).
 */
public class Ex03CustomCollectorUsage {
